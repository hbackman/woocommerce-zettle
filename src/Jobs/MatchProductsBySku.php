...
/**
 * Attempt to match up existing products with Zettle using the SKU.
 *
 * Note:
 *   This job is work in progress and does currently only handle
 *   connecting product variations.
 */
class MatchProductsBySku
{
    /**
     * The plugin instance.
     */
    ...
    /**
     * MatchProductsBySku constructor.
     */
